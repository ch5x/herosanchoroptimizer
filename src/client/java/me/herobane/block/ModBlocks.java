...
public class ModBlocks {
    ...
    public static final Block FAKE_ANCHOR = register("fake_anchor", Block::new,
            Block.Settings.create().nonOpaque().strength(-1.0f).dropsNothing().replaceable().sounds(BlockSoundGroup.POWDER_SNOW)); // can't Break
    ...
    private static Block register(String path, Function<AbstractBlock.Settings, Block> factory,
        ...
        final Identifier identifier = Identifier.of("herosanchoroptimizer", "fake_anchor");
